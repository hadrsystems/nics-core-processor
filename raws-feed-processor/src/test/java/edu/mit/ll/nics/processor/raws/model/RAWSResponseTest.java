...
public class RAWSResponseTest {
    ...
    public void verifyNoErrors() {
        ...
        RAWSResponse rawsResponse = new RAWSResponse(RAWSSummary,null, null, "FeatureCollection", null);
    ...
    public void verifyNoErrorsWhenRequestReturnsZeroResults() {
        ...
        RAWSResponse rawsResponse = new RAWSResponse(RAWSSummary, null
                , null, "FeatureCollection", null);
        Assert.assertFalse(rawsResponse.hasErrors());
    }
}
